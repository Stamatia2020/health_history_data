...
$sql = "SELECT empid,firstname,lastname,id, DATE_FORMAT(birthdate,'%d/%m/%Y') as birthdate, user.depid, depname, cost  FROM user, department where user.depid = department.depid and empid between '$empid1' and '$empid2' and lastname between '$lname1' AND '$lname2' and user.depid between '$depid1' and '$depid2' and cost between '$cost1' and '$cost2' order by empid";
...
<br><br>
&nbsp;<a href="showselect_doctor.php">Επιστροφή</a>
